		...
		<div class="wrapper">
			...
			<form action="<?= site_url('Cat/review_step1'); ?>" method="POST">
				...
				<?php if(array_key_exists('cat-hash',$inputs)) {?><input type="hidden" name="cat-hash" id="cat-hash" value="<?= $inputs['cat-hash'] ?>" /> <?php } ?>
					...
					<div class="jumbotron">
						<h2>FIP form</h2>
						<div class="fip-type" id="wet-form"><h4>wet form 5ml/kg</h4>
						...
						<div class="fip-type" id="neuro-form"><h4>neuro form 10ml/kg</h4></div></div>
						<div class="fip-type" id="ocular-form"><h4>ocular form 8ml/kg</h4></div></div>
					</div>
