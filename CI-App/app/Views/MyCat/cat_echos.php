	...
	<body>
  			...
  			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Metrics</a>
					...
					<li class="nav-item dropdown active">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item active" href="<?= site_url('MyCat/my_cat_echographies/'.$cat['cat-hash']); ?>" >Echographies</a>
						 </div>
					</li>
		...
		<div class="wrapper">
			...
			<div class="container text-center">
				<form action="<?= site_url('MyCat/add_echo_pic/'. $cat['cat-hash']) ?> " id="echo-form" method="POST" enctype="multipart/form-data">
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group ">
								<p>Date: <input type="text" name="echography-date" id="echography-date" value="<?= $currentdate ?>"></p>
							</div>
			...
			<div class="container text-center">
				...
				<h2>Echographies for the cat</h2>

				<?php foreach($echographies as $echoDate) { ?>

					<div class="row"><div class="col"><h2><?= $echoDate['echography-date'] ?></h2></div></div>
					<div class="row">
					<?php foreach($echoDate['pictures'] as $picture) { ?>
						<div class="col"> 
						<a target="_blank" href="<?= $picture['url'] ?>"><img width="256" src="<?= $picture['url'] ?>" alt="echography picture"></a>
						<br/>
						
						<a class="btn btn-primary" href="<?= site_url('MyCat/my_cat_del_echo/'.$cat['cat-hash'].'/'.$echoDate['echography-date-url'].'/'.$picture['file']) ?>">del</a>	
						</div>
		...
		<script>$( function() { $( "#echography-date" ).datepicker(); $( "#echography-date" ).datepicker("setDate", "<?= $currentdate ?>"); } );</script>
	</body>
</html>
