	...
	<body>
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown active">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item active" href="<?= site_url('MyCat/my_cat_eyes/'.$cat['cat-hash']); ?>" >Eyes</a>				 
		...
		<div class="wrapper">
			...
			<div class="container text-left">
				...
				<form action="<?= site_url('MyCat/add_eyes_pic/'.$cat['cat-hash']) ?>" id="eyes-form" method="POST" enctype="multipart/form-data">
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group ">
								<p>Date: <input type="text" name="eyes-date" id="eyes-date" value="<?= $currentdate ?>"></p>
							</div>
			...
			<div class="container text-center">
				...
				<h2>Eyes pictures for the cat</h2>

				<?php foreach($eyes as $eyeDate) { ?>

					<div class="row"><div class="col"><h2><?= $eyeDate['eye-date'] ?></h2></div></div>
					<div class="row">
					<?php foreach($eyeDate['pictures'] as $picture) { ?>
						<div class="col"> 
						<a target="_blank" href="<?= $picture['url'] ?>"><img width="256" src="<?= $picture['url'] ?>" alt="eyes picture"> </a>
						<br/>
						<a class="btn btn-primary" href="<?= site_url('MyCat/my_cat_del_eyes/'.$cat['cat-hash'].'/'.$eyeDate['eye-date-url'].'/'.$picture['file']) ?>">del</a>
						</div>
					<?php } ?>
					</div>
		...
		<script>$( function() { $( "#eyes-date" ).datepicker(); $( "#eyes-date" ).datepicker("setDate", "<?= $currentdate ?>"); } );</script>
	</body>
</html>
